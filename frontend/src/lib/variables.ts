...
export const variables = {
    currentState: import.meta.env.VITE_WEBSITE_STATE ? import.meta.env.VITE_WEBSITE_STATE : 'dev',
    goBackendURL: import.meta.env.VITE_GO_BACKEND_URL
        ? import.meta.env.VITE_GO_BACKEND_URL
        : 'localhost',
    goBackendPort: import.meta.env.VITE_GO_BACKEND_PORT ? import.meta.env.VITE_GO_BACKEND_PORT : 8080,
